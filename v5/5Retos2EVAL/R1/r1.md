...
1. **Servidor web Apache** (no hace falta realizarlo)

   Reconfigurar Apache como servidor web.
   Cada cliente dispondrá de su propio espacio de publicación web ubicado en:

      `/srv/clientes/clienteX/www/`

   Por lo tanto, modificariamos los que ya tuvieramos como La *Asociación de Turismo Ecológico "EcoTravel"*. moviendo sus archivos a este directorio y modificando el DocumentRoot a este directorio.
